  ...
  communications: [
    {
      ...
      f2fCheckIn: { type: Boolean, default: false },
      f2fRaEvent: { type: Boolean, default: false },
      f2fGameOrPractice: { type: Boolean, default: false },
      basecampOrEmail: { type: Boolean, default: false },
      phoneOrText: { type: Boolean, default: false },
      familyMeeting: { type: Boolean, default: false },
...
const alias = {
  ...
  'comm.student.phoneText': 'communcations[0].phoneOrText',
  'comm.student.notes': 'communcations[0].notes',
  ...
  'comm.family.phoneText': 'communcations[1].phoneOrText',
  'comm.family.meeting': 'communications[1].familyMeeting',
  'comm.family.notes': 'communcations[1].notes',
  ...
  'comm.teacher.phoneText': 'communcations[2].phoneOrText',
  'comm.teacher.notes': 'communcations[2].notes',
  ...
  'comm.coach.phoneText': 'communcations[3].phoneOrText',
  'comm.coach.notes': 'communcations[3].notes',
